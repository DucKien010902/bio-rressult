    ...
    >
      ...
      >
        ...
        {sidebarOpen && (
          <div className="leading-none flex flex-col">
            <span className="font-extrabold text-[#003399] tracking-tight text-base">
              GENTECH
            </span>
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer relative ${
                isActive
                  ? 'text-[#0070f3] bg-sky-50/80 font-bold shadow-2xs'
                  : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100/70'
              }`}
            >
              {isActive && (
                <span className="absolute left-0 top-1.5 bottom-1.5 w-1 bg-[#0070f3] rounded-r-full" />
              )}
      ...
      <div className="p-3 border-t border-slate-100 bg-slate-50/60 flex items-center justify-between">
        <div className="flex items-center gap-2.5 truncate">
          <div className="w-8 h-8 rounded-full bg-blue-100 border border-blue-200 text-[#003399] flex items-center justify-center font-bold text-xs shrink-0">
